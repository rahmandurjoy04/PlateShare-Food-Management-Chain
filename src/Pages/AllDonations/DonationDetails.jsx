...
const DonationDetails = () => {
  ...
  if (isLoading) return <div className="text-center mt-10">Loading details...</div>;
  ...
  const canConfirmPickup = dummyUser.role === 'charity' && donation.delivery_status === 'Requested';
  ...
  return (
    <div className="max-w-xl min-w-sm mx-auto bg-white shadow-lg rounded p-8 my-10 space-y-6">
      ...
      <div className="flex flex-col space-y-4 ">
        ...
        {dummyUser.role === 'charity' && donation.delivery_status === 'Available' && (
          <button
