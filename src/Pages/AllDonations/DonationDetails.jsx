...
const DonationDetails = () => {
    ...
    return (
        <div className="max-w-11/12  flex flex-col md:flex-row gap-6 min-w-sm mx-auto  rounded  my-10 space-y-6">
            {/* Image */}
            <div className="w-full md:w-1/2  mb-6 relative">
                <button
                    onClick={() => navigate(-1)} // -1 goes back one page in history
                    className="mb-4 px-4 py-2 bg-primary hover:bg-primary/70 gap-2 text-black rounded flex justify-center  items-center font-semibold"
                >
                    <IoMdArrowRoundBack></IoMdArrowRoundBack> Back
                </button>

                <img src={donation.image} alt={donation.title} className='rounded-md h-auto md:sticky md:top-20 z-10' />
            </div>

            <div className='w-full md:w-1/2'>
                {/* Titles and info */}
                <h1 className="text-4xl font-bold text-primary">{donation.title}</h1>

                <div className="flex items-center space-x-3 my-1">
                    <span
                        className={`px-3 py-2 rounded-full font-semibold uppercase tracking-wide ${donation.delivery_status === 'Available'
                ...
                <div className="space-y-2">
                    <p><strong className="text-lg text-primary font-semibold">Food Type:</strong> {donation.foodType}</p>
                    <p><strong className="text-lg text-primary font-semibold">Quantity:</strong> {donation.quantity}</p>
                    <p><strong className="text-lg text-primary font-semibold">Restaurant:</strong> {donation.restaurantName}</p>
                    <p><strong className="text-lg text-primary font-semibold">Location:</strong> {donation.location}</p>
                    <p><strong className="text-lg text-primary font-semibold">Pickup Time:</strong> {donation.pickupTime}</p>
                </div>
                    ...
                    )}
                    {
                        user && <>
                            <button
                                ...
                                className="mt-4 w-full bg-primary hover:bg-primary/70 text-white font-semibold px-4 py-2 rounded-md"
                            >
                                Add Review
                            </button>
                        </>
