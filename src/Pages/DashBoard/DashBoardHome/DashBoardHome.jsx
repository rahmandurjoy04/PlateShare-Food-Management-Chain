        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {stats.byFoodType.map((stat, index) => (
              ...
              >
                <div className="card-body">
                  ...
                  <p className="text-base-content/70">Donations: {stat.restaurants.reduce((sum, rest) => sum + rest.donationCount, 0)}</p>
            ...
            {stats.byFoodType.length === 0 && (
              <p className="text-center text-base-content/70 col-span-full">No verified donations found.</p>
            )}
          </div>
        </div>
      </div>
